...
export default function ArticlesPage() {
  ...
  return <main className="site-shell articles-shell"><SiteHeader /><section className="articles-hero"><div><div className="section-kicker">11 / Медиа</div><h1>Зуби без<br /><em>складних слів.</em></h1><p>Короткі пояснення від команди Active Medical про профілактику, дитячу стоматологію та підготовку до консультації.</p><div className="articles-hero-actions"><a className="button button-coral" href="/#booking">Поставити запитання лікарю <ArrowUpRight size={16} /></a><span><Search size={17} /> Без діагнозів і залякування</span></div></div><div className="articles-hero-note"><span>✦</span><b>Редакційний принцип</b><p>Пояснювати складне спокійно, перевіряти джерела й завжди залишати місце для особистої консультації.</p></div></section><section className="articles-list section-pad"><div className="section-kicker">01 / Обрані матеріали</div><div className="section-heading"><h2>Корисне,<br /><em>коли потрібно.</em></h2><p>Матеріали мають інформаційний характер. Остаточні рішення щодо лікування приймаються після огляду лікаря.</p></div><div className="article-grid">{dentalArticles.map((article, index) => <ArticleCard key={article.slug} article={article} index={index} />)}</div></section><section className="articles-social section-pad"><div><div className="section-kicker">02 / Життя клініки</div><h2>Більше відповідей<br /><em>у Facebook.</em></h2><p>Дивіться новини, відео та пояснення команди на офіційній сторінці стоматології Active Medical у Миколаєві.</p></div><a className="button button-coral" href="https://www.facebook.com/p/%D0%A1%D1%82%D0%BE%D0%BC%D0%B0%D1%82%D0%BE%D0%BB%D0%BE%D0%B3%D1%96%D1%8F-%D0%90%D0%BA%D1%82%D0%B8%D0%B2-%D0%9C%D0%B5%D0%B4%D1%96%D0%BA%D0%B0%D0%BB-%D0%9C%D0%B8%D0%BA%D0%BE%D0%BB%D0%B0%D1%97%D0%B2-61558068189082/" target="_blank" rel="noreferrer"><Facebook size={17} /> Відкрити Facebook <ArrowUpRight size={16} /></a></section><footer className="footer"><Link className="footer-brand" href="/"><img src="/manus-storage/active-medical-official-logo_c0e6b7c3.png" alt="Актив Медікал" /><div><b>Актив</b><span>Медікал</span></div></Link><p>Стоматологія, в якій<br />вам спокійно.</p><span className="footer-copy">© 2026 Active Medical</span></footer></main>;
}
