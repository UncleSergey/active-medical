...
import { Check, Edit3, LockKeyhole, Plus, Search, Archive, Save, X } from "lucide-react";
  ...
  return <main className="admin-knowledge-shell">
    ...
    <section className="admin-knowledge-layout">
      <form className="admin-knowledge-editor" onSubmit={submit}>
        ...
        <button className="button button-coral admin-save-button" type="submit" disabled={createMutation.isPending || updateMutation.isPending}><Save size={16} /> {editing ? "Зберегти зміни" : "Створити запис"}</button>
