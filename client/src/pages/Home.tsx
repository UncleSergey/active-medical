...
const beforeAfterImage = "/manus-storage/instagram-before-after-case-01_5c368b86.webp";
const promoImageOne = "/manus-storage/promo-bleaching-2550_b8b40bcd.jpg";
const promoImageTwo = "/manus-storage/promo-bleaching-3168_f5cb7a1b.jpg";
const promoImageThree = "/manus-storage/promo-bleaching-3170_f848e1a7.jpg";
const promoImageProcess = "/manus-storage/promo-bleaching-process-2559_eeddf459.jpg";
...
export default function Home() {
  ...
  return (
    <main className="site-shell">
      ...
      <section id="promotions" className="promotions-section section-pad"><div className="section-kicker">03 / Акції</div><div className="section-heading"><h2>Особливі умови<br /><em>для вашої усмішки.</em></h2><p>Актуальні пропозиції Active Medical діють обмежений час. Показання та план процедури лікар визначає на консультації.</p></div><div className="promo-layout"><div className="promo-offers"><article className="promo-offer promo-offer-blue"><div className="promo-offer-top"><span>01</span><b>АКТУАЛЬНО</b></div><h3>Професійна<br /><em>чистка зубів.</em></h3><p>Глибокий рівень: комплексне видалення відкладень, AirFlow, ультразвук-скейлер, полірування та фторування.</p><div className="promo-price"><strong>1 800 <small>грн</small></strong><del>2 500 грн</del></div><button className="button button-coral" onClick={() => scrollTo("booking")}>Скористатися <ArrowUpRight size={16} /></button></article><article className="promo-offer promo-offer-pink"><div className="promo-offer-top"><span>02</span><b>АКТУАЛЬНО</b></div><h3>Апаратне<br /><em>відбілювання.</em></h3><p>Освітлення на кілька відтінків за одну процедуру — після огляду та професійної консультації.</p><div className="promo-price"><strong>4 500 <small>грн</small></strong><del>5 500 грн</del></div><button className="button button-coral" onClick={() => scrollTo("booking")}>Записатися <ArrowUpRight size={16} /></button></article></div><div className="promo-gallery" aria-label="Реальні фото клінічних етапів відбілювання"><figure className="promo-tile promo-tile-large"><img src={promoImageOne} alt="Зуби до професійної процедури" /><figcaption><b>До</b><span>реальний клінічний кадр</span></figcaption></figure><figure className="promo-tile promo-tile-tall"><img src={promoImageTwo} alt="Зуби до процедури в іншому клінічному кейсі" /><figcaption><b>До</b><span>відтінок до процедури</span></figcaption></figure><figure className="promo-tile"><img src={promoImageThree} alt="Клінічний кадр пацієнтки до відбілювання" /><figcaption><b>До</b><span>інший клінічний кейс</span></figcaption></figure><figure className="promo-tile promo-tile-process"><img src={promoImageProcess} alt="Етап професійного відбілювання зубів" /><figcaption><b>Етап</b><span>процес процедури</span></figcaption></figure></div></div></section>
      ...
      <section id="results" className="results-section section-pad"><div className="section-kicker">05 / До / Після</div><div className="results-grid"><div className="results-copy"><h2>Результат,<br /><em>який видно.</em></h2><p>Показуємо реальні клінічні приклади з профілю Active Medical. Кожен випадок потребує індивідуальної консультації та плану лікування.</p><a className="text-button" href="https://www.instagram.com/stomatologactive/" target="_blank" rel="noreferrer">Більше прикладів в Instagram <Instagram size={16} /></a></div><figure className="before-after-card"><img src={beforeAfterImage} alt="Клінічний приклад до та після стоматологічного лікування Active Medical" /><figcaption><span>До / Після</span><small>Реальний клінічний приклад · @stomatologactive</small></figcaption></figure></div></section>

      <section id="team" className="team-section section-pad"><div className="team-photo"><img src={doctorImage} alt="Мезінова Аліна Віталіївна — лікар-стоматолог Active Medical" /><div className="team-photo-secondary"><img src={doctorImageSecondary} alt="Диченко Юлія Андріївна — щелепно-лицевий хірург Active Medical" /></div><div className="team-photo-tertiary"><img src={doctorImageTertiary} alt="Погулич Ярослав Євгенович — імплантолог, хірург, ортопед Active Medical" /></div><div className="team-photo-quaternary"><img src={doctorImageQuaternary} alt="Федоров Іван Михайлович — лікар-стоматолог Active Medical" /></div><div className="photo-label">Люди<br /><em>команди</em></div></div><div className="team-copy"><div className="section-kicker">06 / Команда</div><h2>Ваші лікарі —<br /><em>ваші союзники.</em></h2><p>Ми не ховаємося за білими халатами. Говоримо просто, працюємо уважно і завжди залишаємо вам право на запитання.</p><div className="doctor-list">{doctors.map((doctor, index) => <div className="doctor-row" key={doctor.name}><span className="doctor-number">0{index + 1}</span><div><strong>{doctor.name}</strong><span>{doctor.role} · {doctor.detail}</span></div><ArrowUpRight size={17} /></div>)}</div></div></section>
