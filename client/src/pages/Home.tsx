  ...
  return (
    <main className="site-shell">
      ...
      <section id="top" className="hero-section">
        ...
        <div className="hero-visual"><img src={heroImage} alt="Світлий кабінет стоматологічної клініки" /><div className="hero-caption"><span>Миколаїв · ЖК Рів'єра</span><span>Пн–Сб / 10:00–18:00</span></div><div className="hero-stamp">AM<br /><small>care first</small></div></div>
      </section>
