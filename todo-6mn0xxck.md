...
# Выравнивание подписей по значкам

- [x] Выровнять центры «Сучасно», «Безпечно», «Індивідуально» по центрам трёх значков
- [x] Проверить выравнивание на desktop/mobile без изменения hero artwork и CTA
- [x] Опубликовать точечный checkpoint (checkpoint follows)
- [x] Уточнить ширину desktop overlay, чтобы три подписи совпадали с фактическими центрами значков и не заходили на портрет
