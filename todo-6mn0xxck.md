...
- [ ] Спроектировать безопасного AI-помощника: навигация, ответы общего информационного характера, запись и явное ограничение «не диагноз и не замена врачу»
- [ ] Добавить AI-помощника через разрешённую интеграцию и покрыть его loading/error/guardrail-сценарии тестами
...
- [ ] Добавить 1–2 современные отличительные UX-функции, связанные с услугами и записью, без медицинской диагностики
