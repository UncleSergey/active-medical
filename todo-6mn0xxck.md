...
- [ ] Шаг 1: обновить Telegram bot token через защищённую конфигурацию и подтвердить `getMe`/credential-тест
- [ ] Шаг 2: добавить автоматический мониторинг доступности всех storage-ассетов с уведомлением о сбоях
- [ ] Шаг 3: настроить lazy-loading для тяжёлых командных фотографий и проверить загрузку изображений
- [ ] Проверить и опубликовать каждый шаг отдельным checkpoint
